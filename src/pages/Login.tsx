...
import { IonButton, IonPage, IonContent, IonInput, IonLabel, IonItem, useIonRouter, 
  IonButtons, IonIcon, IonHeader, IonToolbar, IonTitle } from "@ionic/react"
...
const Login:React.FC = () => {
  ...
  const {username, setUsername, setLogin, setModalOpen, isModalOpen} = useStore();
